...
public class Response {
    ...
    private List<WxArticle> mWxArticleList;
    ...
    public List<WxArticle> getWxArticleList() { return mWxArticleList;}

    public void setWxArticleList(List<WxArticle> wxArticleList) { this.mWxArticleList = wxArticleList;}

    @Override
    public String toString() {
        return "Response{" + "errorCode=" + errorCode + ", errorMsg='" + errorMsg + '\'' + ", mWxArticleList=" + mWxArticleList + '}';
    }
}
